...
[![OpenCart Sürümü](https://img.shields.io/badge/OpenCart-2.3-blue.svg)](https://www.opencart.com/)
[![PHP Sürümü](https://img.shields.io/badge/PHP-5.4%2B-777bb4.svg)](https://php.net/)
[![Lisans](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)

**MorPOS for OpenCart**, OpenCart 2.3 mağazalarına **Morpara MorPOS** ödeme sistemini entegre eden güvenli ve kullanımı kolay bir ödeme ağ geçidi eklentisidir. Müşteriler, siparişlerini tamamlarken güvenli **Barındırılan Ödeme Sayfası (HPP)** akışı üzerinden yönlendirilir veya **Gömülü Ödeme Formu** kullanabilir.

## 📦 Diğer Versiyonlar

> **📌 Not**: Bu branch **OpenCart 2.3** sürümünü desteklemektedir. Başka versiyonlar mı arıyorsunuz?
> - **OpenCart 2.x**: [2.x branch](https://github.com/morpara/morpos-opencart/tree/2.x) gidin
...
- 🛒 **OpenCart Entegrasyonu**: OpenCart 2.3 için MorPOS'u ödeme yöntemi olarak sorunsuzca ekler
...
| Bileşen | Kontrol |
|---------|---------|
| **PHP Sürümü** | 5.4+ gerekli, 5.6/7.0+ önerilen |
| **OpenCart Sürümü** | 2.3.0.0+ gerekli, 2.3.0.2+ önerilen |
...
2. **Yerel Ortamı Kurun**
   - OpenCart 2.3'ü yerel olarak yükleyin
...
- OpenCart 2.3 ile uyumluluğu koruyun
- Fonksiyonlar ve sınıflar için PHPDoc yorumları ekleyin
- Anlamlı commit mesajları yazın
- OpenCart 2.3 dizin yapısını takip edin (ödeme dosyaları `language/*/payment/` içinde, `language/*/extension/payment/` değil)
