...
class ControllerPaymentMorposGateway extends Controller
{
    ...
    public function index()
    {
        ...
        $this->load->model('payment/morpos_gateway');
        $this->model_payment_morpos_gateway->ensureTableExists();
    ...
    {
        $this->load->model('payment/morpos_gateway');
        $this->model_payment_morpos_gateway->createTable();
    ...
    {
        $this->load->model('payment/morpos_gateway');
        $this->model_payment_morpos_gateway->dropTable();
    }
