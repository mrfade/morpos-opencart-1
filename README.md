...
[![OpenCart Version](https://img.shields.io/badge/OpenCart-2.0--2.2-blue.svg)](https://www.opencart.com/)
[![PHP Version](https://img.shields.io/badge/PHP-5.3%2B-777bb4.svg)](https://php.net/)
[![License](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)

**MorPOS for OpenCart** is a secure and easy-to-use payment gateway extension that integrates the **Morpara MorPOS** payment system with OpenCart 2.0-2.2 stores. Customers are redirected through a secure **Hosted Payment Page (HPP)** flow or can use an **Embedded Payment Form** when completing their orders.

## 📦 Other Versions

> **📌 Note**: This branch supports **OpenCart 2.0, 2.1, and 2.2**. Looking for other versions?
> - **OpenCart 2.3.x**: Visit the [2.3.x branch](https://github.com/morpara/morpos-opencart/tree/2.3.x)
...
- 🛒 **OpenCart Integration**: Seamlessly adds MorPOS as a payment method for OpenCart 2.0-2.2
...
| Component | Check |
|-----------|-------|
| **PHP Version** | 5.3+ required, 5.6/7.0 recommended |
| **OpenCart Version** | 2.0.0.0+ required, 2.2.0.0 recommended |
...
- **Turkish (turkish)**: Native support
...
2. **Set Up Local Environment**
   - Install OpenCart 2.0-2.2 locally
...
3. **Make Changes**
   ...
   - Test with OpenCart 2.0, 2.1, and 2.2
...
- Maintain compatibility with OpenCart 2.0-2.2
- Include PHPDoc comments for functions and classes
- Write meaningful commit messages
- Follow OpenCart 2.x directory structure (payment files in `controller/payment/` and `language/*/payment/`)
- Use `.tpl` template files (not `.twig`)
- Use `$this->language->load()` for language file loading
